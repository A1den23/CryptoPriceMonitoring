...
BTC_VOLATILITY_WINDOW_SECONDS=240

# ETH Configuration
ETH_ENABLED=true
ETH_SYMBOL=ETHUSDT
ETH_INTEGER_THRESHOLD=100
ETH_VOLATILITY_PERCENT=3.5
...
SOL_VOLATILITY_WINDOW_SECONDS=120
...
```env
# BTC: 每$1000提醒，240秒内波动3%提醒（相对稳定）
BTC_ENABLED=true
BTC_INTEGER_THRESHOLD=1000
BTC_VOLATILITY_PERCENT=3.0
BTC_VOLATILITY_WINDOW_SECONDS=240

# ETH: 每$100提醒，180秒内波动3.5%提醒（中等波动）
ETH_ENABLED=true
ETH_INTEGER_THRESHOLD=100
ETH_VOLATILITY_PERCENT=3.5
ETH_VOLATILITY_WINDOW_SECONDS=180

# SOL: 每$10提醒，120秒内波动5%提醒（高波动）
SOL_ENABLED=true
SOL_INTEGER_THRESHOLD=10
SOL_VOLATILITY_PERCENT=5.0
SOL_VOLATILITY_WINDOW_SECONDS=120
...
```env
# BTC: 240秒内波动3%提醒（相对稳定）
BTC_VOLATILITY_PERCENT=3.0
BTC_VOLATILITY_WINDOW_SECONDS=240

# ETH: 180秒内波动3.5%提醒（中等波动）
ETH_VOLATILITY_PERCENT=3.5
ETH_VOLATILITY_WINDOW_SECONDS=180
...
# BNB: 180秒内波动3.5%提醒（中等波动）
BNB_VOLATILITY_PERCENT=3.5
BNB_VOLATILITY_WINDOW_SECONDS=180
```

**配置说明：**
- **BTC**：波动最小，使用更低阈值(3%)和更长窗口(240秒)
- **ETH/BNB**：中等波动，使用中等阈值(3.5%)
- **SOL**：波动最大，使用更高阈值(5%)和更短窗口(120秒)
- **USD1**：稳定币，保持极低阈值(0.5%)
